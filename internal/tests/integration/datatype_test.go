...
var dataTypeTable = []DataTypeTest{
	...
	},
	{
		...
		pgTypeName:        "boolean[]",
		schemaType:        datatypes.ARRAY,
		elementSchemaType: datatypes.BOOLEAN,
	...
	},
	{
		...
		columnNameOverride: "qchar[]",
		schemaType:         datatypes.ARRAY,
		elementSchemaType:  datatypes.STRING,
		value:              []int32{'F', 'T', 'O'},
		expected:           quickCheckValue[string],
		missingSupport:     true,
	},
	...
	},
	{
		...
		pgTypeName:        "int2[]",
		schemaType:        datatypes.ARRAY,
		elementSchemaType: datatypes.INT16,
		value:             []int16{5, 10, 15},
		expected:          quickCheckValue[string],
		missingSupport:    true,
	},
	{
		...
		pgTypeName:        "int4[]",
		schemaType:        datatypes.ARRAY,
		elementSchemaType: datatypes.INT32,
		value:             []int32{5, 10, 15},
		expected:          quickCheckValue[string],
		missingSupport:    true,
	},
	...
	},
	{
		...
		pgTypeName:        "bytea[]",
		schemaType:        datatypes.ARRAY,
		elementSchemaType: datatypes.BYTES,
	...
	},
	{
		...
		pgTypeName:        "int8[]",
		schemaType:        datatypes.ARRAY,
		elementSchemaType: datatypes.INT64,
		value:             []int64{5, 10, 15},
		expected:          quickCheckValue[string],
		missingSupport:    true,
	},
	...
	},
	{
		...
		pgTypeName:        "float4[]",
		schemaType:        datatypes.ARRAY,
		elementSchemaType: datatypes.FLOAT32,
	...
	},
	{
		...
		pgTypeName:        "float8[]",
		schemaType:        datatypes.ARRAY,
		elementSchemaType: datatypes.FLOAT64,
	...
	},
	{
		...
		pgTypeName:        "polygon[]",
		schemaType:        datatypes.ARRAY,
		elementSchemaType: datatypes.STRUCT,
		value:             []float64{14.1, 12.7},
		expected:          quickCheckValue[string],
		missingSupport:    true,
	},
...
type DataTypeTest struct {
	...
	schemaType         datatypes.SchemaType
	elementSchemaType  datatypes.SchemaType
	value              any
	insertPlain        bool
	valueOverride      any
